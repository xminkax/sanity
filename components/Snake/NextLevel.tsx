...
const dictionary = {
  ...
  "level_2": ["You have entered the space and the comete has arrived.","No sound, no music. Only silence and stars.", "Wish something, not out loud, not with words. Just wish."],
  "level_3": ["Drift through the vast expanse of the cosmos, where swirling nebulae and shifting clouds paint the fabric of space."],
  "level_4": ["A new world awaits. Get ready to venture through the stars and beyond. Coming soon..."],
}
