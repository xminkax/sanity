...
//   });
//
//   const textMesh: Mesh<TextGeometry, MeshBasicMaterial> = new THREE.Mesh(
//     textGeometry,
//     textMaterial,
//   );
...
//           i,
//           velocity * Math.sin(pointBasicCoordinate),
//           velocity * Math.cos(pointBasicCoordinate),
//           Math.random() * 5 - 10,
//         );
//
...
//         textMesh[i].position.set(
//           textMeshSetup[i].position.x,
//           textMeshSetup[i].position.y,
//           textMeshSetup[i].position.z,
//         );
...
//         y =
//           particlesPosition.getY(i) +
//           Math.sin(pointBasicCoordinate) * Math.cos(pointBasicCoordinate) * velocity;
